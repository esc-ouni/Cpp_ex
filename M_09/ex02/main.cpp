...
int main(int argc, char *argv[]){
    ...
    print(vector);
    std::cout << "After without : ";
    print(vector2);
    std::cout << "Time to process a range of " << vector.size() << " elements without    : " << spent_time(n) << " µs" << std::endl;
    std::cout << "Time to process a range of " << vector2.size() << " elements with Jacob : " << spent_time(n1) << " µs" << std::endl;
