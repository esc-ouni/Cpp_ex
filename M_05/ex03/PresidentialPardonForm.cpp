...
PresidentialPardonForm::PresidentialPardonForm(PresidentialPardonForm const &r_inst){
    (*this) = r_inst;
};

PresidentialPardonForm &PresidentialPardonForm::operator=(PresidentialPardonForm const &r_inst){
